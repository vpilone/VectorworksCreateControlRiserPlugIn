...
def CreateDialog():
    ...
    def GetPluginString(ndx):
        # Static Text
        if ndx == 1001:			return 'Add Another Item'
        elif ndx == 1002:		return 'Done'
        elif ndx == 1003:		return 'Dialog'
        elif ndx == 1004:		return 'Other Control Item Information'
        elif ndx == 1005:		return 'Name:'
        elif ndx == 1006:		return ''
        elif ndx == 1007:		return 'IP (Optional):'
...
def DialogHandler (item, data):
    #accepts other data if provided
    if item == kOK:
        global nameData
        global ipData
        global dialog
